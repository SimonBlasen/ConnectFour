...
import de.cogsys.ai.sogo.player.AIRöderDoll;
...
public class Sogo {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 100; i++) {
			...
			final SogoPlayer p1 = new AIRöderDoll(); // new ConsolePlayer(br);
			final SogoPlayer p2 = new MrNovice(); // new ConsolePlayer(br);
			...
			case P1:
				...
				System.out.println("p1 = " + p1.getClass().toString());
				p1Wins++;
				break;
			case P2:
				System.out.println("Player 2 (O) wins");
				System.out.println("p2 = " + p2.getClass().toString());
				p2Wins++;
				break;
			case NONE:
